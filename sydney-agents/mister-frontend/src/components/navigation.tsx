...
export function Navigation() {
  ...
  return (
    <nav className="fixed -top-1 left-1/2 -translate-x-1/2 z-[9999] bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b border-l border-r rounded-b-lg p-2 shadow-lg pointer-events-auto">
