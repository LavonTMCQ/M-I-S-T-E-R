...
export class PerformanceAnalyzer {
  ...
  static generateResults(
    ...
    const tradeAnalyses = this.analyzeIndividualTrades(trades);
   ...
   */
  private static calculatePeriodReturns(portfolioValues: { timestamp: Date; value: number }[], initialCapital: number) {
